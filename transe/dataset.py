...
class KnowledgeGraph:
    ...
    def load_dicts(self):
        ...
        entity_df = pd.read_csv(os.path.join(self.data_dir, entity_dict_file), header=None,
    ...
    def load_triples(self):
        ...
        training_df = pd.read_csv(os.path.join(self.data_dir, training_file), header=None,
                                  sep='\t', keep_default_na=False)
        ...
        validation_df = pd.read_csv(os.path.join(self.data_dir, validation_file), header=None,
                                    sep='\t', keep_default_na=False)
        ...
        test_df = pd.read_csv(os.path.join(self.data_dir, test_file), header=None, sep='\t', keep_default_na=False)
